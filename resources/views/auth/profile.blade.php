    ...
    <div class="max-w-4xl mx-auto px-6 py-8">
        ...
        <div class="gradient-bg text-white rounded-3xl p-8 mb-8 shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center gap-6">
                ...
                @else
                    <div class="w-24 h-24 rounded-full bg-white bg-opacity-20 flex items-center justify-center text-4xl border-4 border-white shadow-lg">
                        👤
                    </div>
                @endif
                <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow p-6 border border-red-50">
                <h3 class="text-lg font-bold text-red-800 mb-1">👤 Edit Profile</h3>
                <p class="text-xs text-gray-400 mb-6">Update your personal information</p>
            ...
            {{-- Change Password --}}
            <div class="bg-white rounded-2xl shadow p-6 border border-red-50">
                <h3 class="text-lg font-bold text-red-800 mb-1">🔒 Change Password</h3>
                <p class="text-xs text-gray-400 mb-6">Update your account password</p>
        ...
        {{-- Account Stats --}}
        <div class="bg-white rounded-2xl shadow p-6 border border-red-50 mt-6">
            <h3 class="text-lg font-bold text-red-800 mb-4">📊 My Activity</h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="text-center p-4 bg-red-50 rounded-xl">
                    <p class="text-3xl font-bold text-red-800">{{ auth()->user()->items()->where('type', 'lost')->count() }}</p>
                    <p class="text-sm text-gray-500 mt-1">Lost Reports</p>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-xl">
                    <p class="text-3xl font-bold text-red-800">{{ auth()->user()->items()->where('type', 'found')->count() }}</p>
                    <p class="text-sm text-gray-500 mt-1">Found Posts</p>
                </div>
                <div class="text-center p-4 bg-red-50 rounded-xl">
                    <p class="text-3xl font-bold text-red-800">{{ auth()->user()->claims()->count() }}</p>
                    <p class="text-sm text-gray-500 mt-1">Claims Made</p>
                </div>
            </div>
        </div>
