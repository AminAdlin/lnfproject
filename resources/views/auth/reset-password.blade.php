...
<body class="bg-red-50 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        ...
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-red-800">🔍 UTM FoundIt</h1>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ old('email', $email) }}" placeholder="example@utm.my" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-800 @error('email') border-red-500 @enderror" />
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <input type="password" id="password" name="password" placeholder="••••••••" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-800 @error('password') border-red-500 @enderror" />
